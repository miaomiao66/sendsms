...
class ChuangLan
{
    ...
    {
        $curConfigs = file_exists(config_path('sendsms.php')) ? include config_path('sendsms.php') : include __DIR__.'/config/default.php';
        // $curConfigs     = include __DIR__.'/config/default.php';
        $curConfigs     = $curConfigs['agents']['ChuangLan'];
